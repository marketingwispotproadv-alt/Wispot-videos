...
export const SCENES: SceneDef[] = [
  ...
  },
  {
    ...
    chunks: [
      { words: [{ text: "Ele", start: 0.0, end: 0.28 }, { text: "controla", start: 0.28, end: 0.86 }, { text: "o", start: 0.86, end: 1.0 }, { text: "tráfego", start: 1.0, end: 1.64 }] },
      { words: [{ text: "e", start: 1.64, end: 1.86 }, { text: "define", start: 1.86, end: 2.22 }, { text: "os", start: 2.22, end: 2.38 }, { text: "acessos.", start: 2.38, end: 2.98 }] },
    ],
  },
  {
