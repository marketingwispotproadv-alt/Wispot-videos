...
Esta peça tem 59,47 s, contra 52,93 s do firewall e 66,17 s do vídeo de
...
python3 tools/fit_music.py public/proadv/audio/trilha.mp3 \
    public/terceiros/audio/trilha.mp3 59.47
```

- batida medida por autocorrelação do envelope de ataque: **110,3 BPM**,
  compasso de 2,1756 s;
- miolo de 13,27→41,55 s repetido por 3 compassos;
- resultado de **59,18 s**, normalizado a −20 dBFS de RMS.

Sobram 0,29 s de silêncio no fim, porque a emenda cai em compasso inteiro e não
