...
A peça do firewall tem 52,93 s e esta tem 68,27 s, então a faixa precisou de
...
python3 tools/fit_music.py public/proadv/audio/trilha.mp3 \
    public/cartorio/audio/trilha.mp3 68.27
```
...
Sobram 0,39 s de silêncio no fim, porque a emenda cai em compasso inteiro e não
...
```bash
python3 tools/fit_music.py original.mp3 public/cartorio/audio/trilha.mp3 68.27
```
